...
void InitGraphics(void)
{
	...
	models.push_back(pair<int, ObjModel*>(100, new ObjModel("models/car/honda_jazz.obj")));
	...
	models.push_back(pair<int, ObjModel*>(30, new ObjModel("models/ship/shipA_OBJ.obj")));
}
